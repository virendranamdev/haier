...
$result = $obj->getoneachiverpostdetails($postId);;
        ...
        <div style="width:100%;height:auto;margin-top: 80px;">
            ...
            <div class="row">
                ...
                <div ng-app="" class="col-xs-6 col-sm-6 col-md-6 col-lg-6"> 
                    ...
                    <form method="post" action="Link_Library/link_approveStory.php" enctype="multipart/form-data">
                        <input type="hidden" value="<?php echo $value['posts'][0]['clientId']; ?>" name="clientId" readonly="">
                        <input type="hidden" value="<?php echo $value['posts'][0]['createdBy']; ?>" name="createdBy" readonly="">
                        <input type="hidden" value="<?php echo $value['posts'][0]['firstName']; ?>" name="auth" readonly="">
                        <input type="hidden" value="<?php echo $value['posts'][0]['storyId']; ?>" name="storyId" readonly="">
                      
                        <input type="hidden" value="<?php echo $value['posts'][0]['flagType']; ?>" name="flag" readonly="">
                        <input type="hidden" value="<?php echo $value['posts'][0]['post_img']; ?>" id="hidAchiverImage" name="hidAchiverImage" readonly="">

                        <?php echo "<img src='" . $path . $value['posts'][0]['post_img'] . "' id='memoryMedia' style='cursor:hand;' class='img img-responsive' onerror='this.src = &quot;images/board.png&quot;' >"; ?> 
                        
                       <!-- <input type="file" name="memoryImage" id="memory" style="display:none;" onchange="showimagepreview1(this)">-->
                        
                        <b>Title : </b>
                        <input style="width:98%;color: black;" type="text" name="title" id="title" class="form-control user-success" placeholder=" Choose a heading for this memmory..." value="<?php echo $value['posts'][0]['post_title']; ?>">
                        <br>
                        <b>Content : </b>
                        <textarea style="color:#2d2a3b;" class="form-control user-error" rows="4" id="comment" cols="8" name="achiver_content" placeholder="Event Description" required="" aria-invalid="true"> <?php echo $value['posts'][0]['post_content']; ?> </textarea>
                        <!--<textarea style="margin-left: 3px;" cols="61" rows="5" name="memory_content"><?php echo $value['posts'][0]['post_content']; ?></textarea>-->
                        <br>
						<!-------------------------------------------------------------->
						...
						<div class="form-group col-sm-12">
						 <input type="submit" class="btn btn-md btn-info news_postBtn" style="text-shadow:none;font-weight:normal;" name="update" id="update" value=" Approve Hall Of Fame ">
...
<script>
    ...
    var status;
    var reason;
    function Job_approve_dissapprove(storyId, status) {
        window.location.href = "Link_Library/link_approveStory.php?memoryid=" + storyId + "&memorystatus=" + status + "&page=achiver;
    }
</script>
-->
