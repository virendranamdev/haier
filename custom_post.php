		...
		<div class="row">
			...
			<div class="row">
				<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
						...
						<label for="Article image">GALLERY IMAGE</label>
...
<div>
<input type="file" name="fil" id="fi" onchange="showimagepreview1(this)" />
</div>
</form>
  ...
  <textarea class="form-control" rows="8" id="comment"cols="8"placeholder="Short paragraph to draw attention to the article... "></textarea>
</div>
				</div>
