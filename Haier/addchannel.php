...
<div style="border:1px solid #dcdcdc;padding:8px;">
					...
					<hr />
                          ...
                          <div ng-repeat = "distinctValuesWithinColumn in singleColumnValues.distinctValuesWithinColumn  ">
                              ...
                              <input type="checkbox" ng-checked="isCheckedDemographic('{{singleColumnValues.columnName}}', '{{distinctValuesWithinColumn}}') || all" name="group{{$parent.$index}}[]" class="form-group" value="{{singleColumnValues.columnName}}| {{distinctValuesWithinColumn}}" ng-click="sayhello($parent.$index)">  {{distinctValuesWithinColumn}}
