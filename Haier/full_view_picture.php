        ...
        <div style="width:100%;height:auto;margin-top: 80px;">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" style="border: 1px solid #f1f1f0;">
					...
					<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<?php echo "<div style='font-size: 11px; font-weight: bold;color: gray; margin-bottom: 1%; margin-top:10px;'>" . $value['posts'][0]['created_date'] . "</div>"; ?>
					</div>
					</div>
                   ...
                   <!--<?php
                    ...
                    echo "<p style='text-align: justify;white-space:pre-wrap !important;'>" . $word . "</p><br>";
                    ?>
					</div>
					</div>
