...
<div class="container-fluid">
                                ...
                                <form name="form1" id="form1" method="post">
                                    ...
                                    for ($i = 0; $i < $count; $i++) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="padding_right_px"><?php echo $val['posts'][$i]['status']; ?></td>
    ...
    <button type="button"class="btn btn-sm  btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete
                                                ...
                                                <a href="Link_Library/post_status.php?postid=<?php echo $val['posts'][$i]['post_id']; ?>&poststatus=<?php echo $val['posts'][$i]['status']; ?>&page=leadership" style="color:#CE3030;margin-left:30px !important"><?php echo $action; ?>
                                                </a>
