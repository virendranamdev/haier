                    ...
                    <div id="inneriphone6">
                        <div class="row" ><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 " style="background-color: #5cb85c;
                            ...
                            <div class="iphoneSubParentDiv" style="padding-left:5px;">
                                <div class="row">
                                    <div class="col-xs-12 col-md-4 col-sm-4 col-lg-4" ><img src="images/usericon.png"class="img img-responsive img-circle"id="user_image_priview_news"/></div>
                                    <div class="col-xs-12 col-md-8 col-sm-8 col-lg-8"><p id="HRnamenewsPriview"><?php echo $username; ?></p><p id="Date_newsPriview">Date: <?php echo date("d/m/Y"); ?></sub> </div>

                                </div>
                                <!--<div class="messageTitlePost"></div>
                                <div class="contentPost"></div>
                                -->
                                <div class="row" style="padding-left:9px;padding-right:10px;padding-bottom:22px;">
