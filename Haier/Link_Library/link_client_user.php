...
//        echo '<pre>';print_r($_POST);die;
        ...
        $result = $obj->userForm($clientid, $user, $first_name, $middle_name, $last_name, $emp_code, $dob, $doj, $email_id, $designation, $department, $contact, $location, $branch, $grade, $gender, $officeno,$rmanager,$address);
        print_r($result);
    }
} else {
    ?>
