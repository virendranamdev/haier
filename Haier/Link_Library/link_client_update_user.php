...
$result = $obj->userFormUpdate($emp_id,$emp_name,$emp_last,$temp_depar,$emp_desig,$emp_loc,$emp_bra,$emp_gra,$idclient,$user_unique_id,$emp_middle,$emp_emailid,$emp_mobile,$emp_office,$emp_rmanager,$address);
