...
function ValidateNews()
{
	...
	//alert("image "+uploadimage.value);
	//alert("video"+uploadvideo.value);
	//alert($("#filUpload").is(":visible"));
	//alert($("#video_url").is(":visible"));
	...
	/*if (uploadimage.value == "" && $("#filUpload").is(":visible"))
        {
        ...
        <div class="bs-example">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"style="margin:1px !important;">
                    <h4><strong>Update News</strong></h4><hr>
                    <?php
...
//           echo'<pre>';print_r($result);die;
	    ...
	    $title = htmlspecialchars($result[0]['post_title'], ENT_QUOTES); 
            ?>
