...
if ($dev == 'd2') {
	...
	$device = 'panel';
    $result = $obj->getSingleOnboard($value, $clientid,$device);
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    foreach ($post_content_keys as $keys => $val) {
                        ...
                        ?>
                        <br>
                        <div style="font-size: 16px;font-family: calibri, sans-serif; text-align: justify;white-space:pre-wrap !important;"><?php
