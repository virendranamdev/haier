...
<div class="side-menu sidebar-inverse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="panel panel-default dropdown">
                        ...
                        <div id="ViewPost" class="panel-collapse collapse">
                            <div class="panel-body">
                                <ul class="nav navbar-nav">
                                    <li><a href="view_news.php"><span class="icon fa fa-newspaper-o"></span>News</a>
                                    </li>
                        ...
                        <div id="ViewPost" class="panel-collapse collapse">
                            <div class="panel-body">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="view_ceo_message.php"><span class="icon fa fa-newspaper-o" aria-hidden="true"></span>Leadership Talk
                                        </a></li>  
    ...
    <!--   <li><a href="view_recognize.php"><span class="icon fa fa-hand-o-right" aria-hidden="true"></span> View Recognition
        ...
        <!--  <li><a href="view_recognize_analytics.php"><span class="icon fa fa-hand-o-right" aria-hidden="true"></span> View Recognition analytics
                                    ...
                                    <li><a href="view_album.php"><span class="icon fa fa-picture-o" aria-hidden="true"></span>Haier Gallery
                                        </a></li>
                                <!---    <li><a href="view_mylifemahle.php"><span class="icon fa fa-picture-o" aria-hidden="true"></span> My Life at Mahle
                                   ...
                                   <!-- <li><a href="view_welcome_onboard.php"><span class="icon fa fa-newspaper-o" aria-hidden="true"></span>Welcome Onboard</a></li>  -->  
                                    ...
                                    <li><a href="view_event.php"><span class="icon fa fa-newspaper-o "></span>Event</a>
                                    </li>
    ...
    <li><a href="view_alumni_memory.php"><span class="icon fa fa-picture-o"></span>Alumni Memory</a>
                    ...
                    <li class="panel panel-default dropdown">
                        <a data-toggle="collapse" href="#notice">
                            <span class=" icon fa fa-bullhorn"></span><span class="title"> Communique</span>
                        </a>
                        <!-- Dropdown level 1 -->
                        <div id="notice" class="panel-collapse collapse">
                            <div class="panel-body">
                                <ul class="nav navbar-nav">
                                    <li><a href="create_notice.php"><span class="glyphicon glyphicon-plus"></span> Add Communique</a>
                                    </li>
                                    <li><a href="view_Notice.php"><span class="glyphicon glyphicon-pushpin"></span> View Communique</a>
                                    </li>
                    ...
                    <li class="panel panel-default dropdown">
                        <a data-toggle="collapse" href="#contributor">
                            <span class="icon fa fa-flag-checkered" aria-hidden="true"></span><span class="title">My Learning
                            </span>
                        </a>
                        ...
                        <div id="contributor" class="panel-collapse collapse">
                            <div class="panel-body">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="create_mylearning.php"><span class="glyphicon glyphicon-plus"></span> Add Learning</a>
                                    </li>
                                    <li><a href="viewLearning.php"><span class="glyphicon glyphicon-plus"></span> View Learning</a>
                                    </li>
                        ...
                        <div id="analyticlogin" class="panel-collapse collapse">
                            <div class="panel-body">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="analytic_activeuser.php"><span class="glyphicon glyphicon-plus"></span>Active User Analytic</a>
                                    </li>
