          ...
          <div class="container-fluid">
            <div class="side-body padding-top">
              <?php
                ...
                <div class="row">
                    <div class="col-xs-11 col-sm-offset-1"style="border:2px solid #dcdcdc;padding:5px;margin-top:-100px;margin-left:6%;" >
                         <div class="card">
...
if($count>0)
{
echo "<div style='overflow-x:auto;'><table border='1' style='width: 100%;border: 1px solid #ADA4A4;font-size: 14px;'><tr><th>First Name</th><th>Last Name</th><th>Email Id</th><th>Employee Id</th><th>Department</th><th>Designation</th><th>Location</th><th>Branch</th><th>Grade</th><th>Action</th></tr>";
for($i=0;$i<$count;$i++)
{
