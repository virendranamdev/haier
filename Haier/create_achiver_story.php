...
<div class="iphoneSubParentDiv">
 ...
 <div class="row mobile_articals"><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 "><i class="fa fa-arrow-left"style="color:#fff !important;    padding-top: 12px;"></i><font class="white_color">Article</font></div>
                    <div class="row">
...
<hr style="height:1px;background-color:gray;width:92%;">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <h3><strong>Hall of Fame</strong></h3><hr>
    </div>
...
<!---------------------------------long news from start here--------------------------------->	
 ...
 <form name="form1" role="form" action="Link_Library/link_post_achiver_story.php" method="post" enctype="multipart/form-data"  onsubmit="return check()">
...
<video muted controls  id="videoPlayer" width="300px" style=" display: none;">
