...
<div style="width: 100%;height: 163px;border: 1px solid #ccc;padding: 10px 20px;font-size: 16px;margin: 10px 0px;">
<div style="width: 30%;max-height:140px;overflow-y:auto ;border: 1px solid #ccc;padding: 10px 20px;font-size: 16px;float:left">
<h6>Branch</h6><hr>
<?php
$value = $getcat['branch'];
$count = count($value);
