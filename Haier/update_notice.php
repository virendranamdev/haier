...
function ValidateNotice()
{
	...
	<!-------------------------------SCRIPT END FROM HERE   --------->	
			...
			<div class="row">
				...
				<h3><strong>Update Communique</strong></h3><hr>
				<?php 
...
<input style="color:#2d2a3b;" type="hidden" name ="noticeid" value="<?php echo $_GET['noticeid']; ?>">
						<input style="color:#2d2a3b;" type="text" name="noticetitle" class="form-control" value="<?php echo htmlspecialchars($result['posts'][0]['noticeTitle'],ENT_QUOTES); ?>">
					</div>
...
<center><input style="color:#2d2a3b;"type="submit" name="update_notice" class="btn btn-md btn-info publishnowBtn" style="text-shadow:none;font-weight:normal;" value="Save" onclick="return ValidateNotice();"/></center>
  </div>	
			     </div>
				</form>
			    </div>
