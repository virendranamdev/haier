...
?>
 ...
 <!--   <a href="update_channel.php?clientid=<?php echo $getcat[$i]['clientId']; ?>&groupid=<?php echo $getcat[$i]['groupId']; ?>"><button type="button"class="btn btn-sm  editbtn"><span class="glyphicon glyphicon"></span>Edit</button></a> -->
											...
											{
											?>
											<a href="viewCustomGroupDetail.php?clientid=<?php echo $getcat[$i]['clientId']; ?>&groupid=<?php echo $getcat[$i]['groupId']; ?>"style="color:#00a4fd;margin-left:10px !important;"><span class="glyphicon glyphicon"></span>View</a>
											<?php 
											}
											?>
