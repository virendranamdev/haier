...
<img src="<?php echo $val['Data'][$i]['imageName']; ?>"class="img img-rounded"id="news_images" onerror='this.src="images/u.png"'/> </td>
                                        ...
                                        $word = implode(" ", array_splice($words, 0, 10));
                                               ...
                                               // echo $val[$i]['title']; ?></td>
											    <td style="padding-left:21px;"><?php echo $val['Data'][$i]['TotalCount']; ?></td>
												 <td style="padding-left:21px;"><?php echo $val['Data'][$i]['ViewPostCount']; ?></td>
                                                <!--<td><?php echo $val['Data'][$i]['venue']; ?></td>
                                                <td><?php echo $val['Data'][$i]['eventTime']; ?></td>
                                                  <td><?php echo $val['Data'][$i]['eventCost']; ?></td>-->
                                                <td style="padding-left:21px;"><?php echo $val['Data'][$i]['registration']; ?></td>
                                               <td>
                               ...
                               <td style="padding-left:21px;"><?php echo $val['Data'][$i]['status']; ?></td>
