		  ...
		  var postData = 
               ...
               $.ajax({
				...
				for (var i = 0; i < resdata.length; i++) {
					...
					var newRow = '<tbody><tr><td>' + jsonData[i].sn + '</td><td>' + jsonData[i].employeeID + '</td><td>' + jsonData[i].firstName + '</td><td>' + jsonData[i].department + '</td><td>'+ jsonData[i].location +'</td><td>' + jsonData[i].deviceName + '</td><td>' + jsonData[i].date_entry_time +'</td></tr><tbody>';
...
<div class="row" >
    ...
    <h3 style="margin-left:3px;"><strong>Analytic</strong></h3>
	<hr>
    </div>
	...
	<input type="hidden" name="clientid" id="clientid" value="<?php echo $clientid; ?> ">
		...
		<div class="form-group">
			<label for="pwd"></label>
			<button type="button" class="form-control btn btn-primary" onclick="return check();">Submit</button>
		...
		<div class="form-group">
			...
			<select style="color:#2d2a3b;" name="graphexport" class="form-control" id="graphexport" onchange="return graphorexport();">
					...
					<option value ="graph">Show Graph <span class="glyphicon glyphicon-stats pull-right"></span> </option>
					<option value ="export">Export In CSV <span class="glyphicon glyphicon-save-file pull-right"></span></option>
			</select>
		</div>
		</div>
		</form>
			...
			<!---<div class="addusertest">
	              ...
	              <div class="side-body"style="    margin: 0px 13px 10px 13px;">
                        ...
                        <div class="col-xs-12">
                            <div class="card">
								...
								<input type="hidden" name="jsres" id="jsres">
                                    <table class="table table-responsive" cellspacing="2" width="100%" id="myTable1">
                                        <thead>
                                            <tr>
												<th>SN</th>
												<th>Employee ID</th>
