                        ...
                        <div class="col-xs-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="title"><strong>All Communique Details</strong></div>
                                    </div>
...
?>
                                               ...
                                               <td style="width:22%;">
                                             <a href="<?php echo $val[$i]['fileName']; ?>" target="_blank"style="color:#00a4fd;margin-left:10px;">View</a>
 ...
 <button style="background-color:#fff;color:<?php echo $color;?>;" class="btn btn-sm" <?php echo $dis .">".$action; ?></button></a>
