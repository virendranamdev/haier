 ...
 <form name="form1" role="form" action="Link_Library/link_EmployeeTrainingDetails.php" method="post" onsubmit="return check()"> 
  ...
  <div ng-app="" class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="form-group">
        <label for="TITLE">Learning Name:</label>
        <select class="form-control" name="trainingid" id="trainingid" required>
		<option value="0" selected>-----Select learning---</option>
			<option><?php 
				...
				for($i=0; $i<count($id); $i++)
					{
						...
						echo  "<option value=".$trainingid."-".$trainingName.">".$trainingName."</option>";
					} 
					?></option>
  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="form-group">
        ...
        <input style="color:#2d2a3b;" type="date" class="form-control" required name="trainingdate" id="trainingdate" placeholder="Enter Learning Date">
		</div>
    </div>
	</div>
...
<input style="color:#2d2a3b;" type="submit" name="news_post"  class="btn btn-md btn-info news_postBtn" style="text-shadow:none;font-weight:normal;" value="Publish Now" onclick="return ValidatePostlearning();" />
