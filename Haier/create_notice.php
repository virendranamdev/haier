...
<script>
    function check() {
        if (confirm('Are You Sure, You want to publish this Communique?')) {
            return true;
        } else {
            return false;
        }
                ...
                <div id="AndoidPriviewTab" class="tab-pane fade in active">  
                    ...
                    <div class="androidContentTab" >
                        <div  style="background-color: #5cb85c;
                              margin: 0px;
                              height: 32px;border: 1px solid #5cb85c;"><i class="fa fa-arrow-left"style="color:#fff !important;    padding-top: 8px;"></i><font style="color:white;">&nbsp;&nbsp;&nbsp;Article</font></div>
                        <div class="wholeAndroidContentHolder">

                            <div class="noticetitle" style="font-weight:bold;"></div>
                            <div class="noticecontent" style="height:230px;overflow-y:scroll;"></div>		
                            <div class="row" style="margin-top:0px;margin-bottom:3px;margin-left:3px;">
                                <div class="col-lg-6 col-sm-6 col-md-6"><font style="font-size:10px;">0 Likes</font><br><button type="button" class="btn btn-xs"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i><font style="font-size:10px;">Like</font></button> </div>
                                <div class="col-lg-6 col-sm-6 col-md-6"><font style="font-size:10px;"> 0 Comments</font><button type="button" class="btn btn-xs"><i class="fa fa-commenting-o" aria-hidden="true"></i><font style="font-size:10px;">Comments</font></button></div>
                            </div>
                        </div>
...
<div class="side-body padding-top">
    <div class="" style="border:1px solid #cdcdcd;padding:20px;margin-bottom:20px;margin-top:80px;">
        <div class="bs-example">


            <div class="row" style="padding-top:30px;">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <h3><strong>Communique</strong></h3><hr>
                    <?php
