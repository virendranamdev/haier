                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < $count; $i++) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a target="_blank" href="full_view_message.php?idpost=<?php echo $val[$i]['post_id'] ?>"> <?php
                                            ...
                                            if (strlen($string) > 40) {
                                                ...
                                                $string = substr($stringCut, 0, strrpos($stringCut, ' ')) . "....<a style='color:#00a4fd;margin-left:10px !important' href='full_view_message.php?idpost=" . $val[$i]['post_id'] . "'></a>";
                                            }
                                            ?>
                                            ...
                                            <td><?php echo $val[$i]['TotalCount']; ?></td>
                                            <td><?php echo $val[$i]['ViewPostCount']; ?></td>
                                            <td><?php echo $val[$i]['likeCount']; ?></td>
                                            <td><?php echo $val[$i]['commentCount']; ?></td>

                                            <td><?php echo $val[$i]['status']; ?></td> 
