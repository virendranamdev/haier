...
function compress_image($source_url, $destination_url, $quality) {
  ...
  function create_Post($cid,$pid,$ptitle,$pimg,$POST_IMG_THUMB,$pteaser,$pcontent,$pdate,$mail,$by,$flag,$like,$comment,$video_url='')
  {
     $this->postid = $pid;
     ...
     $query = "insert into Tbl_C_PostDetails(clientId,post_id,post_title,post_img,thumb_post_img,postTeaser,post_content,created_date,created_by,userUniqueId,flagcheck,likeSetting,comment,status,video_url)
                                      values(:cid,:pid,:pt,:pi,:thumbimg,:lname,:pc,:cd,:cb,:em,:fl,:lk,:ck,:st,:video_url)";
