...
//echo $rt;
    ...
    function generateLoginOTP($mob, $email, $empid) {
        ...
        try {
            ...
            if ($rows_found > 0) {
//echo $rows_found;
                $loginsms = "Your My Haier Password is " . $password;
                ...
                /*                 * *******************************send mail***************************************** */
                $to = $emailid;
                $subject = 'My Haier Password';
                $from = 'myhaier@benepik.com';
                ...
                $message .= '<p>Your My Haier Password is  ' . $password . '</p><br>';
