     ...
     $this->value = $val;
        ...
        $rows = $stmt->fetchAll(PDO::FETCH_ASSOC);
            ...
            /****************************************************************************************************/
				  ...
				  $eventquery = "select * from Tbl_Analytic_PostSentToGroup where groupId IN('".$in."') and clientId =:cid order by autoId asc";
	       ...
	       /***********************************************************************/
						...
						{
						    $qu = "select post_id from Tbl_C_PostDetails where post_id=:pid and clientId=:cid and status = 1 and flagCheck = 17";
