...
//    echo "<br/>".$this->password;
  //  echo "<br/>".$user_password;
     ...
     join Tbl_EmployeePersonalDetails as UP on UP.employeeId = U.employeeId where UPPER(U.emailId) = :mail or 
     UPPER(U.employeeCode) = :mail";
 ...
 /******************************************* forfet password ****************************/  
   ...
   try
   {
   $rt = "select * from Tbl_EmployeeDetails_Master where UPPER(emailId) =:mail or UPPER(employeeCode)=:mail";
  ...
  $query3 = "update Tbl_EmployeeDetails_Master set password =:pass where emailId =:email or employeeCode =:email";
...
$message .= "<p>Regards,</p>";
$message .= "<p>Team My Haier</p>";
$message .= '</body></html>';

$headers1 = "From: My Haier <myhaier@benepik.com> \r\n";
