...
<hr style="height:1px;background-color:gray;width:92%;">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h3><strong>Post Welcome Popup</strong></h3><hr>
				</div>
...
<!--************************pop up end for live privie iphones output****************************** -->
			...
			<form role="form" name="postpictureform" action="Link_Library/link_post_popup.php" method="post" enctype="multipart/form-data" onsubmit="return check()">
...
<input type="file" name="uploadimage" id="filUpload" accept="image/*" onchange="showimagepreview(this)" multiple="true" />
				...
				<div class="form-group">
						<!--<label for="Articlecontent">Caption</label>-->
				<!--<textarea style="color:#2d2a3b;" class="form-control" name="content" id="content" rows="1" placeholder="Choose a caption for this image..." ></textarea>-->
				<input type="hidden" style="color:#2d2a3b;" class="form-control" name="content" id="content"placeholder="Choose a caption for this image..." value="">
				</div>
				</div>
				<!--
