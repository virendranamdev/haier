                                ...
                                <form method="post" name="adduserform" action="Link_Library/link_client_user.php" onsubmit="return check()">
									...
									<div class="row">                
                                        <div class="form-group col-sm-4">
                                            ...
                                            <input style="color:#2d2a3b;" type="text" class="form-control" name="contact" placeholder="Enter Contact number"/>

                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label for="exampleInputPassword1">Location</label>
                                            <input style="color:#2d2a3b;"type="text" class="form-control" name="location" placeholder="Enter Location"/>

                                        </div>
										<div class="form-group col-sm-4">
                                            <label for="exampleInputPassword1">Branch</label>
                                            <input style="color:#2d2a3b;" type="text" class="form-control" name="branch" placeholder="Enter Branch"/>
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <input style="color:#2d2a3b;" type="text" class="form-control" name="grade" placeholder="Enter Grade"/>

                                        </div>
										<div class="form-group col-sm-4">
                                            <label for="exampleInputPassword1">Office No</label>
                                            <input style="color:#2d2a3b;" type="text" class="form-control" name="officeno" placeholder="Enter Office No."/>

                                        </div>
										 
										 <div class="form-group col-sm-4">
                                            <label for="exampleInputPassword1">Reporting Manager</label>
                                            <input style="color:#2d2a3b;" type="text" class="form-control" name="rmanager" placeholder="Enter Reporting Manager"/>
										...
										<div class="row">
										 <div class="form-group col-sm-12">
                                            ...
                                            <textarea style="color:#2d2a3b;" class="form-control" name="address" placeholder="Enter Address" rows='2'></textarea>
                                        </div>
