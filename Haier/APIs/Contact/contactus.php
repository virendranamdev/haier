...
// Access-Control headers are received during OPTIONS requests
    ...
    if ($jsonArr["clientid"]) {
        ...
        if ($result['success'] == 1) {
            ...
            $msg1.="Dear " . $username . ",";
            $msg1.="<br/>";
            $msg1.="<br/>Thanks for contacting My Haier. We have received your message";
            $msg1.="<br/><br/>";
            ...
            $msg1.="<br/><br/><br/><br/>";
            $msg1.="Regards, <br/> Team My Haier";
            $from = "From: My Haier<" . $dedi . ">";
...
//$to = "webveeru@gmail.com";
            $subject = "Contact Us Submitted on My Haier ";
