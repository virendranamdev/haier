...
if (!empty($jsonArr['clientid'])) {
  ...
  //  $createComment2 = json_decode($createComment1,true);
    
                        
    /***************** Add earning point*******************/
     $flagType = 5;             // module flagtype
    
    $checkdata = $earnobj->checkUserEntry($flagType,$employeeid, $post_id);
   
    if(count($checkdata) == 0)
    { 
    //    $createComment2["message"] = "Comment posted successfully.10 points credited to your account";
  $earnobj->addpostcommenteReward($clientid, $employeeid,$flagType,$post_id);
    }
 //    $createComment = json_encode($createComment2);
    /************************************/
