...
if (!empty($jsonArr)) {
    ...
    if ($result['success'] == 1) {
        ...
        $msg.="Dear " . $name . ",";
        $msg.="<br/><br/>";
        $msg.="<br/>Thank you for providing merchant reference to My Haier. We will soon contact the merchant for potential tie up.";
        $msg.="<br/><br/>";
        ...
        $msg.="<br/><br/><br/>";
        $msg.="Regards, <br/> Team My Haier";

        $from = "From: My Haier <myhaier@benepik.com>";

        if ($mail != "") {
            $mesg->forMail($mail, $sub, $msg, $from);
        }

        $sub2 = "Merchant refered on My Haier";
