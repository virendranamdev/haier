...
<div class="container-fluid">
    ...
    <button type="button"class="btn btn-sm  btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete
											...
											<a target="_blank" href="update_onboard.php?idpost=<?php echo $val['posts'][$i]['post_id'] ?>&cid=<?php echo $clientid; ?>" style="color:#00a4fd;margin-left:29px !important;">Edit</a>
																						
											<a href="Link_Library/post_status.php?postid=<?php echo $val['posts'][$i]['post_id']; ?>&poststatus=<?php echo $val['posts'][$i]['status']; ?>&page=onboard" style="color:#CE3030;margin-left:30px !important"><?php echo $action; ?>
