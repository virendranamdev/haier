...
<!--<a href="view_survey_result1.php?qid=<?php echo $value[$i]['surveyId']; ?>&clientid=<?php echo $value[$i]['clientId']; ?>&sid=<?php echo $surveyid; ?>" style="color:#00a4fd;margin-left:29px !important;">Result</a>   --->
