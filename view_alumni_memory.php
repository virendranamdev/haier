...
$result = $object->getMemories($clientid);
        ...
        <div class="" style="border:1px solid #cdcdcd;padding:20px;margin-bottom:20px;margin-top:20px;">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-title">
                                <div class="title"><strong>Alumni Memories</strong></div>
                            </div>
                            <div style="float:left; margin-top:13px; font-size:20px;"> 
                                <a href="post_alumni_memory.php">
                                    <!--<button type="button" class="btn btn-primary btn-sm">Add Alumni Memory</button>-->
                                </a>
                            </div>
                        </div>
                                    ...
                                    for ($i = 0; $i < $count; $i++) {
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <img src="<?php echo $path . $val[$i]['imageName']; ?>"class="img img-rounded" id="news_images" onerror='this.src="images/board.png"'/> </td>
                                            <td style="padding-left:40px;"><?php echo $val[$i]['memoryContent']; ?></td>
                                            <!--<td style="padding-left:40px;"><?php echo $val[$i]['jobLocation']; ?></td>-->
                                           <!-- <td style="padding-left:40px;"><?php echo '1'; //$val[$i]['TotalCount'];    ?></td>
                                            <td style="padding-left:40px;"><?php echo '1'; //$val[$i]['ViewPostCount'];    ?></td>
											-->
         ...
         --->                                   <td class="padding_left_px"><?php echo $d; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a target="_blank" href="update_view_alumni_memory.php?memoryId=<?php echo $val[$i]['memoryId'] ?>" style="color:#00a4fd;margin-left:29px !important;" >View</a>
                                                &emsp;&emsp;
                                                <?php
//                                                if ($val[$i]['status'] == 0) {
//                                                    
...
//                                                } else {
                                                ...
                                                <!--<a onClick="javascript:if (confirm('Are you sure want to Delete Post ?')) {
                                                                ...
                                                                return false
                                                            }" href="Link_Library/delete_job.php?jobid=<?php echo $val[0]['jobId']; ?>&page=jobs"><button type="button"class="btn btn-sm  btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</button></a>
															-->
                                            </td>
