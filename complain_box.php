...
$sub_req_url ="http://admin.benepik.com/employee/virendra/benepik_admin/lib/link_get_complain.php";
...
#RecentComment, #latest_activity {
 ...
 <link rel="stylesheet" href="style.css" type="text/css">
    ...
    height: 50px;
    border-radius: 100%;border:1px solid #dcdcdc;
    margin-right: 10px;
    " src="<?php echo $putimg; ?>" onerror='this.src="images/u.png"'/><b><?php echo $emailid; ?></b><br>
<span style="margin-left: 60px;"><?php echo $val[$i]['date_of_complaint'];  ?></span></p>
						<hr>
