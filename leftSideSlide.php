...
<div class="side-menu sidebar-inverse">
                        ...
                        <div id="user" class="panel-collapse collapse">
                            <div class="panel-body">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="network.php"><span class="icon fa fa-users"></span>View User</a>
                                    </li>
                            ...
                            <div class="panel-body">
                                <ul class="nav navbar-nav">
                                   ...
                                   <li><a href="postmessage.php"><span class="icon fa fa-envelope-o"></span> Message</a>
                                     ...
                                     <li><a href="create_ceo_message.php"><span class="icon fa fa-newspaper-o" aria-hidden="true"></span>CEO Corner</a>
                                    </li>
    ...
    <!-- <li><a href="mylifeatmahle.php"><span class="icon fa fa-cloud-upload" aria-hidden="true"></span>My Life at Mahle</a>
                                  ...
                                  <!---  <li><a href="create_achiver_story.php"><span class="icon fa fa-newspaper-o" aria-hidden="true"></span>Hall of Fame</a>
                                    ...
                                    <li><a href="create_onboard.php"><span class="icon fa fa-newspaper-o" aria-hidden="true"></span>Welcome Onboard</a>

                                    <li><a href="create_event.php"><span class="icon fa fa-newspaper-o"></span>Event</a>
                                    </li>
                                 <!--   <li><a href="create_poll.php"><span class="icon fa fa-newspaper-o"></span> Feedbacks</a>
                                    </li> -->
                            ...
                            <div class="panel-body">
                                ...
                                <!---    <li><a href="view_mylifemahle.php"><span class="icon fa fa-picture-o" aria-hidden="true"></span> My Life at Mahle
                                   ...
                                   <!-- <li><a href="view_welcome_onboard.php"><span class="icon fa fa-newspaper-o" aria-hidden="true"></span>Welcome Onboard</a></li>  -->  
                                    <li><a href="view_event.php"><span class="icon fa fa-picture-o"></span>View Event</a>
                                    </li>
 <li><a href="view_ceo_message.php"><span class="icon fa fa-picture-o" aria-hidden="true"></span>CEO Message
                                        </a></li>          
                   ...
                   <li class="panel panel-default dropdown">
                    ...
                    <div id="pages" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav navbar-nav">
                                <li><a href="view_page.php"><span class="glyphicon glyphicon-file"></span>View Policy</a>
                                </li>
                                <li><a href="addpage.php"><span class="glyphicon glyphicon-plus"></span> Add Policy</a>
                                </li>
                    ...
                    <!---   <li class="panel panel-default dropdown">
                           <a data-toggle="collapse" href="#analytic">
                               <span class="icon fa fa-bar-chart" aria-hidden="true"></span><span class="title">Recognisation Analytics</span>
                           </a>
                    <!-- Dropdown level 1 --
                    <div id="analytic" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav navbar-nav">
                                <li><a href="#"><span class="glyphicon glyphicon-plus"></span>Add Recognisation Budget</a>
                                </li>
                                <li><a href="view_recognize_analytics.php"><span class="glyphicon glyphicon-plus"></span> View Total Earning</a>
                                </li>
                                <li><a href="view_recognize_topic_analytic.php"><span class="glyphicon glyphicon-plus"></span> Recognize Topic Analytic</a>
                                </li>
                                <li><a href="view_voucher_details.php"><span class="glyphicon glyphicon-plus"></span>Voucher Details</a>
                                </li>
                  ...
                  <!--  <li>
                    ...
                    <li class="panel panel-default dropdown">
                       ...
                       <!-- <li>
                         <a href="create_subadmin.php">
                             <span class="icon fa fa-user"></span><span class="title">Create Sub Admin</span>
                         </a>			
                                                 </li>  -->
